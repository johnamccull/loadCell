...
/// \brief		SerialPort object is used to perform rx/tx serial communication.
        ...
        public:
            ...
            /// \brief      Flush port input and output
            void FlushIO();
            ...
            /**
             * @brief       Write with uint8_t* buffer
             */
            void Write(uint8_t* sendBuff, int buffLength);
            ...
            /**
             * @brief       read with uint8_t* buffer
             */
            int Read(uint8_t* rcvbuff, int buffLength);
